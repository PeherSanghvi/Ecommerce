...
const Register = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // Check register response before navigating
      ...
      <div className="w-full max-w-md px-6">
        ...
        >
          <div className="text-center mb-10">
            ...
            <p className="text-gray-600">Join AURA and start your shopping journey</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="flex items-start gap-2">
              ...
              <span className="text-sm text-gray-600">
                I agree to the <Link to="#" className="text-black hover:underline">Terms of Service</Link> and <Link to="#" className="text-black hover:underline">Privacy Policy</Link>
              </span>
            </div>
